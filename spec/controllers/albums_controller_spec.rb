...
RSpec.describe AlbumsController, type: :controller do
  let(:valid_attributes) {{title: 'title', artist_id: FactoryGirl.create(:artist).id, genre: 'genre', year: 'year'}}
  let(:invalid_attributes) {{title: nil, artist_id: nil, genre: nil, year: nil}}
  let(:valid_session) { {} }
